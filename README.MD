...
Checl out and build application using Maven. It uses Spring Boot plugin to package dependencies into single jar. Run jar as usual (Windows syntax here)
```text
...
Next tab looks like this and gives user ability to select character ranges for resulting sprite font.
